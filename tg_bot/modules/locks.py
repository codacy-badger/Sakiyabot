...
LOCK_HANDLER = CustomCommandHandler("lock", lock, pass_args=True)#, filters=Filters.group)
UNLOCK_HANDLER = CustomCommandHandler("unlock", unlock, pass_args=True)#, filters=Filters.group)
